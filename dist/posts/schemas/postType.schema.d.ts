...
export declare const Postschema: import("mongoose").Schema<PostType, import("mongoose").Model<PostType, any, any, any, Document<unknown, any, PostType> & PostType & Required<{
    _id: unknown;
